...
int choice1(void)
{
	...
	printf("||             2- To view reserved ticket :                       ||\n");
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t                                                        \n");
        printf("\t Booking ID : %d \t\t\tShow Name : KRISH\n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for KRISH\n\n");
	printf("\t\t\tpress 2 for KRISH2\n\n");
	printf("\t\t\tpress 3 for KRISH3\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t                     THEATER BOOKING TICKET\n");
        printf("\t\n");
        printf("\t Booking ID : %d \t\t\tShow Name : KRISH2\n",id2);
        printf("\t Customer  : %s\n",name);
...
void ticket3(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t            THEATER BOOKING TICKET\n");
        printf("\\n");
        printf("\t Booking ID : %d \t\t\tShow Name : KRISH3\n",id2);
        printf("\t Customer  : %s\n",name);
